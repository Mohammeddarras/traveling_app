  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        categoryTripsScreen.id: (context) => categoryTripsScreen(_availableTrips),
        tripDetailScreen.id: (context) => tripDetailScreen(_manageFavorite, _isFovarite),
        tabsScreen.id: (context) => tabsScreen(_favoriteTrips),
        filterScreen.id: (context) => filterScreen(_filters, _changeFilters),
      },
    );
  }
}
